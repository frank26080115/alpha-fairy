...
enum
{
    ...
    SONYALPHA_PROPCODE_FocusPointSet      = 0xD232,
...
enum
{
    SONYALPHA_STATEMACHINE_INIT,
    SONYALPHA_STATEMACHINE_OPENSESSION,
    SONYALPHA_STATEMACHINE_GETDEVINFO,
    SONYALPHA_STATEMACHINE_GETSTORAGEIDS,
    SONYALPHA_STATEMACHINE_SDIOConnect1,
    SONYALPHA_STATEMACHINE_SDIOConnect2,
    SONYALPHA_STATEMACHINE_SDIOGetExtDeviceInfo,
    SONYALPHA_STATEMACHINE_SDIOConnect3,
    SONYALPHA_STATEMACHINE_SDIOGetExtDeviceInfo2,
    SONYALPHA_STATEMACHINE_CHECKEVENTS,
    SONYALPHA_STATEMACHINE_SAVEIMG,
};
